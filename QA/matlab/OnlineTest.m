...
ResultFilePath = 'D:\360pan\Data\FieldDialog\copus\OnlineTest\Result.txt';
base_dir = 'D:\360pan\Data\FieldDialog\copus\'; % path to data
base_dir = [base_dir, topic];
workSpaceSavePath = [base_dir,'\Model.mat'];
load(workSpaceSavePath); 

base_dir = 'D:\360pan\Data\FieldDialog\copus\OnlineTest\';
